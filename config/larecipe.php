...
return [
    ...
    */
    ...
    'seo'                 => [
        'author'          => 'Agunfon Interactivity',
        'description'     => 'Documentation for Agunfon Interactivity Moodle plugins.',
        'keywords'        => 'moodle, plugin, documentation, modern video player, agunfon',
        'og'              => [
            'title'       => '',
            'type'        => 'article',
            'url'         => '',
