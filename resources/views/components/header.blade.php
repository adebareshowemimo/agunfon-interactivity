                        ...
                        <div class="w-[1000px] bg-white rounded-[32px] overflow-hidden shadow-float border border-gray-100 flex flex-col">
                            ...
                            <div class="p-10 bg-white">
                                <div class="grid grid-cols-3 gap-x-8 gap-y-7">
                                    @php
                                    $plugins = [
                                        ['https://moderncommerce.dev', 'shopping-bag', 'Modern Commerce', 'Open-source commerce for selling learning through Moodle.'],
    ...
    <div class="flex flex-col h-full overflow-y-auto pt-20 pb-8 px-6">
        <nav class="flex flex-col gap-1">
            ...
            <div class="border-b border-gray-100">
                ...
                <div class="mobile-accordion-content hidden pb-3 pl-4 space-y-2">
                    <a href="https://moderncommerce.dev" class="block text-sm text-gray-600 py-1.5 hover:text-brand-700">Modern Commerce</a>
